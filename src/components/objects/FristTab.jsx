            ...
            <div className="container  ">
                <div  className='flex justify-around items-center  '>
                    <div className=''>
                        ...
                        <div className='flex flex-wrap max-w-[500px]  pt-[50px] gap-[40px]'>
                            {
                                lists.map((element, index) => (
                                    <div key={index}>
                                        <div className='flex items-center w-[223px]'>
                                            ...
                                            <div className=''>
                                                <h1 className='text-[18px] font-jost font-[500] text-[#252525]'>{element.title}</h1>
                                                <p className='text-[18px] font-[300] font-jost text-start'>{element.subtitle}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className='ml-[100px]'>
                        <div>
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><img src={vil} alt=""/></SwiperSlide>
                                <SwiperSlide><img src={wil} alt=""/></SwiperSlide>

                            </Swiper>
                        </div>
                        <div className='flex items-center max-w-[500px] mt-[40px] gap-[20px]'>
                            ...
                            <h1 className='text-[37px] mx-[10px] font-[600] font-OpenSans'>250p</h1>
                            <p className='text-[21px] px-[10px] font-[600] font-OpenSans'>M2</p>
                            <button onClick={() => setShowModal(true)} className='bg-[#343232]  w-[200px] h-[50px] text-[#fff] font-[200] text-[18px] flex items-center justify-center'>Подробнее

                                <svg className='ml-[14px]' width="44" height="8" viewBox="0 0 44 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='fixed top-0 left-[25%] z-[100] shadow-2xl transition-[10s] backdrop-opacity-100'>
                                    <div className='bg-[#FFFFFF] w-[800px] min-h-[100vh] rounded-2xl'>
                                        ...
                                        <div className='flex justify-center items-center'>
                                            ...
                                            <h1 className='text-[400] font-jost text-[#343232;] font-[400]'>1 этаж</h1>
                                        </div>
                ...
                <hr className='w-[100%] text-[#E2E2E2]'/>
                </div>
        </>
    );
}
