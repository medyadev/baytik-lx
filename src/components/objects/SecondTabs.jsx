...
import tweo from '../../assets/img/Rectangle 80.png'
import loo from '../../assets/img/Frame 682.png'
import "swiper/css";
                    ...
                    <div className=''>
                        <div>
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><img className="first-images" src={tweo} alt=""/></SwiperSlide>
                    ...
                    <div className=' akna ml-[100px]'>
                        <div>
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><img className="first-red" src={loo} alt=""/></SwiperSlide>
                        ...
                        <div className=' aziret flex items-center max-w-[500px] mt-[40px] gap-[20px]'>
                            ...
                            <h1  className=' object-h1 text-[37px] mx-[10px] font-[600] font-OpenSans'>300p</h1>
