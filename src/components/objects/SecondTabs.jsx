...
import wilw from '../../assets/img/Frame 682.png'
import rede from '../../assets/img/villa 250 3 (1).png'
      ...
      <div className="container  ">
        <div  className='flex justify-between items-center  frist-tap '>
          <div className=''>
            ...
            <div className='flex  dap flex-wrap max-w-[500px] gap-[40px] pt-[50px]'>
              {
          ...
          <div className=" akna ml-[100px]">
            <div>
              <Swiper
                  ...
                  className="mySwiper"
              >
                <SwiperSlide><img className="first-red" src={rede} alt=""/></SwiperSlide>
                <SwiperSlide><img className="first-red" src={wilw} alt=""/></SwiperSlide>
            ...
            <div className=' aziret flex items-center max-w-[500px] mt-[40px] gap-[20px]'>
              ...
              <button className='bg-[#343232]  w-[200px] h-[50px] text-[#fff] font-[200] text-[18px] flex items-center justify-center'>Подробнее
