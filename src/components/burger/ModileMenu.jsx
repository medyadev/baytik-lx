...
export default function MobileMenu({className}) {
    return (
     <div className="w-full"> 
           <div
            className={`mobile-menu ${className} h-[100%] w-[80%]  bg-[#C9AE5D] left-0 right-0 fixed z-[999] pt-[120px] `}
        >
            <div className=" mx-auto w-[900px]   ">
                <div className=" burger-adap flex justify-between items-center ml-[250px]">
                  <div>
                      <nav className='flex flex-col'>
                          <a className='pt-[20px] font-[Jost] text-white text-3xl font-light leading-[50px]'  href="#glova">Главная</a>
                          <a className='pt-[20px] font-[Jost] text-white text-3xl font-light leading-[50px]'  href="#about">О компании</a>
                          <a className='pt-[20px] font-[Jost] text-white text-3xl font-light leading-[50px]'  href="#object">ЖК - Байтик</a>
                          <a className='pt-[20px] font-[Jost] text-white text-3xl font-light leading-[50px]'  href="#cotege">Выбрать дом</a>
                          <a className='pt-[20px] font-[Jost] text-white text-3xl font-light leading-[50px]'  href="#cotege">Выбрать дом</a>
