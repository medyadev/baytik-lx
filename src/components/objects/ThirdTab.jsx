...
import derf1 from '../../assets/img/Rectangle 80 (4).png'
...
import rooo from '../../assets/img/Rectangle 80 (1).png'
import {Autoplay, EffectCreative, Navigation, Pagination} from "swiper";
import {useState} from "react";
import wrt from '../../assets/img/villa 250 3.png'
import roo from '../../assets/img/Frame 682(1).png'
...
export default function FristTab() {
                    ...
                    <div className=''>
                        <div>
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><img className="first-images" src={rooo} alt=""/></SwiperSlide>
                                ...
                                lists.map((element, index) => (
                                    <div key={index}>
                                        <div className='aza flex items-center w-[223px]'>
                                            ...
                                            <div className=''>
                                                <h1 className='mat text-[18px] font-jost font-[500] text-[#252525]'>{element.title}</h1>
                                                <p className=' pat text-[18px] font-[300] font-jost text-start'>{element.subtitle}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className=' akna ml-[100px]'>
                        <div>
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><img className="first-red" src={roo} alt=""/></SwiperSlide>
                                <SwiperSlide><img className="first-red" src={wil} alt=""/></SwiperSlide>

                            </Swiper>
                        </div>
                        <div className=' aziret flex items-center max-w-[500px] mt-[40px] gap-[20px]'>
                            <svg className='aziret-beka' width="50" height="37" viewBox="0 0 50 37" fill="none"
                            ...
                            <h1  className=' object-h1 text-[37px] mx-[10px] font-[600] font-OpenSans'>350p</h1>
                            <p className=' first-black text-[21px] px-[10px] font-[600] font-OpenSans'>M2</p>
                            <button onClick={() => setShowModal(true)} className=' btn-first bg-[#343232]  w-[200px] h-[50px] text-[#fff] font-[200] text-[18px] flex items-center justify-center'>Подробнее

                                <svg className='jyky ml-[14px]' width="44" height="8" viewBox="0 0 44 8" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {showModal ?   (
                            <div onClick={() => setShowModal(false)} className="top-0 left-0 bg-[#ffffff94]  w-[100%] fixed z-[999] h-[100vh]">
                                ...
                                <div className='fixed modal-line top-[7%] left-[25%] z-[10] shadow-2xl transition-[10s]'>
                                    <div className='bg-[#FFFFFF] w-[800px] h-[800px] rounded-2xl'>
                                        ...
                                        <div className='flex justify-center items-center'>
                                            ...
                                            }} className='w-[45px]' ></div>
                                            <h1 className='font-jost text-[#343232;] font-[400]'>1 этаж</h1>
                                        </div>
                                   ...
                                   <div className='flex justify-around items-center pt-[40px]'>
                                       <div>
                                           <h1 className='text-[14px] font-[300] font-jost'>№ 1</h1>
                                           <h1 className='text-[14px]  font-[300] font-jost'>ОБЩАЯ ПЛОЩАДЬ 290,71 м2 <br/>
                                               1. Холл - 22,11 м2 <br/>
                                       ...
                                       <div>
                                           <h2 className='text-[14px] font-[300] font-jost'>№ 2</h2>
                                           <h1 className='text-[14px] font-[300] font-jost'>ОБЩАЯ ПЛОЩАДЬ 290,71 м2 <br/>
                                               1. Холл - 22,11 м2 <br/>
                                               2. Гостиная - 62,61 м2  <br/>
                                               3. Кухня - 35,91 м2 <br/>
